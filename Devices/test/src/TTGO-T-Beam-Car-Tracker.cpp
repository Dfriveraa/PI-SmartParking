...
static const u4_t DEVADDR = 0x26031740; // LoRaWAN end-device address (DevAddr)
...
static uint8_t mensaje[] = "todo bien";
long nextPacketTime;
...
#ifdef DEBUG
const unsigned int TX_INTERVAL = 15;
#elif
